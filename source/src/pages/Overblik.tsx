...
const MONTHLY_DATA = [
  { month: "Okt", count: 3 }, { month: "Nov", count: 5 }, { month: "Dec", count: 2 },
  { month: "Jan", count: 7 }, { month: "Feb", count: 4 }, { month: "Mar", count: 8 },
];
  ...
  return (
    ...
    >
      <div className="sticky top-0 z-30 pt-12 pb-3 px-5 flex items-center gap-3" style={{ background: "linear-gradient(to bottom, rgba(10,14,35,0.95) 60%, transparent)" }}>
        ...
        <h1 className="text-white text-xl font-bold">Overblik</h1>
      </div>
      ...
      <div className="px-5 mt-2 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="glass-card-strong rounded-2xl p-4">
            ...
            <p className="text-white/40 text-xs">Events i databasen</p>
          </div>
          <div className="glass-card-strong rounded-2xl p-4">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-white/40 text-xs">Steder i databasen</p>
          </div>
          <div className="glass-card-strong rounded-2xl p-4">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-white text-2xl font-bold">12 dage</p>
            <p className="text-white/40 text-xs">Aktiv streak</p>
          </div>
          <div className="glass-card-strong rounded-2xl p-4">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-white/40 text-xs">Mest aktive kategori</p>
          </div>
        </div>

        {/* Monthly activity chart */}
        <div className="glass-card-strong rounded-2xl p-4">
          <h3 className="text-white font-semibold text-sm mb-4">Aktivitet pr. måned</h3>
        ...
        {/* Category breakdown */}
        <div className="glass-card-strong rounded-2xl p-4">
          <h3 className="text-white font-semibold text-sm mb-4">Kategorier {placesCount > 0 && <span className="text-white/30 text-[10px] font-normal">(fra databasen)</span>}</h3>
        ...
        {placesCount > 0 && (
          <div className="glass-card-strong rounded-2xl p-4">
            <h3 className="text-white font-semibold text-sm mb-3">🗄️ Database status</h3>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-white/60 text-xs">Steder (places)</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-white/60 text-xs">Gennemsnitlig rating</span>
