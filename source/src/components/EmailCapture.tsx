...
export function EmailCaptureFooter() {
  ...
  return (
    <div className="fixed bottom-20 left-3 right-3 z-[9998] bg-[#0d1225]/95 backdrop-blur-lg border border-white/10 rounded-2xl px-4 py-3 shadow-2xl shadow-black/50 md:bottom-4 md:left-auto md:right-4 md:max-w-sm animate-in slide-in-from-bottom-4">
      <button
